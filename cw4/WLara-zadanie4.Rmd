...
Interesują nas do analizy jedynie dane z godzin innych niż 10 oraz 18ta.

```{r}
dane %>%
  filter(Godzina != "10:00") %>% ##
  filter(Godzina != "18:00") -> dane
dane
```
...
Przedstawimy różnice ceny otwarcia i zamknięcia z godziny 08:00
...
```{r}
barplot(final1$Max_zamkniecie-1340, names.arg = c('8', '12','16','20'), offset = +1340, xlab = "Godzina", ylab = "Najwyższe ceny")
```
