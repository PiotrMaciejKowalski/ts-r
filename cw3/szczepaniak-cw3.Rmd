...
summary(model)
```
Przedstawimy ten trend liniowy na wykresie
```{r}
...
```{r}
plot(Testowy$Ilosc_Dni, Testowy$Zamkniecie,type="l", col='blue', xlab = "Data", ylab="Cena", ylim=c(2.5,3.0))
lines(Testowy$Ilosc_Dni, Prognoza, col = 'red')

```
Prognoza jest zdecydowanie niedobra.
