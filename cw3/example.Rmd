...
R posiada również możliwość wytworzenie specjalnych zmiennych, które pomagają w diagnostyce problemów objawiających się w danych
...
W przypadku dobrze dobranego modelu powinniśmy obserwować następujące cechy

1. Na wykresie Residuals vs Fitted powniśmy obserwować stałe wahania scentrowane wokół średniej wartości.
1. Na wykresie Q-Q powiniśmy oglądać pokrycie linii przerywanej. Najczęściej jednak wartości skrajnie niedopasowywują się linii. Oznacza to, że model dobrze opanował modelowanie danych pośrednich, ale gorzej radzi sobie z danymi skrajnymi.
1. Scale-location powiniśmy obserwować równomierne wahania w przekroju próby losowej.
1. na Residuals vs Leverage - powiśmy obserwować pojedyncze skupisko próby. Wartości odstają i małe rozłączne grupy sugerują wartości odstające w próbie, które silnie przekładają się na modyfikowanie parametrów modelu.
