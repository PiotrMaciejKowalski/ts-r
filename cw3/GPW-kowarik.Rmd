...
Widać, że dopasowanie modelu w przypadku tak dużej ilości dość znacząco różniących się danych jest słaby o czym świadczy minimalna wartość 'r.squared'.
...
testowy <- cena_zamkniecia[chwila:250,]
```
