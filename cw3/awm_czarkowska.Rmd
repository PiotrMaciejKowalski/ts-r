...
Pierwszym krokiem jest wczytanie danych z poprzedniego zadania. Do wykonania zadania wybraałam kolumnę z cenami otwarcia ze spółki AWM za okres 02.02.2019-22.03.2019
...
```{r}
prognoza2=predict(model_n,data=zb_testowy)
prognoza2
```
...
plot(zb_testowy$otwarcie,
      xlab = "Data", ylab="Ceny otwarcia spółki AWM", type="l", main="Prognoza ceny Otwarcia")
